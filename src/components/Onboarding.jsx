...
const steps = [
  {
    ...
    left: '50%', top: '50%', size: '1em',
    position: 'below'
  },
  {
    description: stepDescriptions[1],
    left: 'calc(50% + 18em)', top: 'calc(50% - 15em)', size: '20em',
    position: 'left'
  },
  {
    description: stepDescriptions[2],
    left: 'calc(50% + 15em)', top: 'calc(50% + 3em)', size: '16em',
    position: 'left'
  },
  {
    description: stepDescriptions[3],
    left: 'calc(50% + 3.5em)', top: 'calc(100% - 4.5em)', size: '8em',
    position: 'above'
  },
  {
      ...
      {step
        ? (
          <Onboarding step={step} onClick={next}>
            <Explanation position={step.position}>
              {step.description}
            </Explanation>
          </Onboarding>
        )
